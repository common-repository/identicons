 ...
 * @since 1.0.0
 */
class Pixicon implements Identicon {
	...
	public function __construct( string $hash ) {
		...
		// Set the file.
		$this->file = trailingslashit( $wp_upload_dir['basedir'] ) . trailingslashit( 'identicons' ) . trailingslashit( $this->hash ) . 'pixicon.png';
		// Set the URL.
		$this->url = trailingslashit( $wp_upload_dir['baseurl'] ) . trailingslashit( 'identicons' ) . trailingslashit( $this->hash ) . 'pixicon.png';
	}
